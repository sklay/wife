...
var audioCon1=document.getElementById("audioCon1");
var audioCon2=document.getElementById("audioCon2");
var audioCon3=document.getElementById("audioCon3");
...
function playMusic(musicCreatId){
	createjs.Sound.play(musicCreatId);
};
...
function checkPattern(cards){
    ...
    if(pattern1==pattern2){
	    ...
	    $hideImg = $('#hide-light-'+pattern1) ;
	    var src = $lightImg.attr('src') ;
	   var dataSrc = $hideImg.attr('src') ;
