...
<html lang="en">
		...
		<script>
			...
			if (is_weixin()) {
				...
				if (grantBoo == "true" || grantBoo == true) {
					...
					location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + appid + '&redirect_uri=' + redirect_uri + wxparam + '&response_type=code&scope=snsapi_userinfo&state={"from_user_id":"${fromUserId}","silent_grant":"no"}#wechat_redirect';
				}
			} else {
		...
		<div class="content">
			<div class="indexPage">
				<div class="content_top clearFix">
					<img src="images/act_18maskIndex-1.jpg" />
					<img src="images/act_18maskIndex-2.jpg" />
					<img src="images/act_18maskIndex-3.jpg" />
					<img src="images/act_18maskIndex-4.jpg" />
				</div>
				<div class="getHbWrap">
					<div class="getHb">
						...
						<!--领取成功  -->
							<div class="receive_success" style="display: none;">
								<div class=" getHbnNum clearFix">
	                   				<img  src="images/act_18maskIndex_succ.png" alt="" />
								</div>
							</div>
							<!-- 领过了 -->
							<div class="has_received " style="display: none;">
								<div class=" getHbnNum clearFix">
									<img  src="images/act_18maskIndex_fail.png" alt="" />
								</div>
							</div>
	...
	wechatObj.imgUrl = 'http://imgstore.camore.cn/icon/logo/act_18maskIndex_shareImg.jpg';
	if (is_weixin()) {
		$.ajax({
