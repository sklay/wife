                        ...
                        success:function(result){
                            ...
                            if(result.result_code==100){
                                ...
                                $(".main_img ul li").bind("click",function(){
                                    ...
                                    console.log(_url);
                                    var url = _url.replace(/store.ykd365.com/g,"store.ykd365.com");
                                    ...
                                    if (r != null){
                                        ...
                                        var arrUrl = "http://store.ykd365.com/medstore/"+urls;
                                        ...
                                        if(user!=null){
                                            var _arrUrls = "http://store.ykd365.com/medstore/"+arrUrls+"&user_token="+user+"&pharmacy_id="+pharmacyId;
                                        }else{
                                            var _arrUrls = "http://store.ykd365.com/medstore/"+arrUrls+"&user_token=&pharmacy_id="+pharmacy_id;
                                        }
                                    ...
                                    $(".nav li").bind("click",function(){
                                        ...
                                        if(type=="bz") {
                                            ...
                                            if($(this).children("span").text()=="邀请好友"){
                                                ...
                                                var title1 = $(this).children("span").text();
                                                localStorage.setItem("title",title1);
                                                localStorage.setItem("url","http://store.ykd365.com/medstore/share/share_1804_1?actId=729&user_token="+user+"&pharmacy_id="+pharmacyId+"&type=category&typeId=1000035625");
                                ...
                                //        var arrUrl = "http://store.ykd365.com/medstore/"+url1;
                                //        console.log(arrUrl);
                                //        localStorage.setItem("url",arrUrl);
                                //        window.parent.location.href="promoinfo.html?title="+title;
                                //    });
                                ...
                                /*品牌找药板块 end*/
                                /*对症找药板块 start*/
                                var sort = result.result_json.symptom_dic.symptom_arr;
