...
<html lang="en">
	...
	<head>
		<meta charset="UTF-8">
		<title>【药快到】好久不见，送你一份健康豪礼！</title>
		<meta name="description" content="免单券、满减折上折，等你来领！">
		<meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no" />
		<meta name="format-detection" content="telephone=no, email=no" />
		<meta name="apple-mobile-web-app-capable" content="yes" />
		<base href="../">
		<link rel="stylesheet" href="style/act_18combination.css?v=000002" />
...
//			}
		...
		<div class="content">
			<div class="indexPage">
				<div class="content_top clearFix">
					<img src="images/act_18combination_1.jpg" />
					<img src="images/act_18combination_2.jpg" />
					<img src="images/act_18combination_3.jpg" />
					<img src="images/act_18combination_4.jpg" />
					<img src="images/act_18combination_5.jpg" />
					<img src="images/act_18combination_6.jpg" />
				</div>
				<div class="getHbWrap">
					<div class="getHb">
						...
						<!--领取成功  -->
							<div class="receive_success" style="display: none;">
								<div class=" getHbnNum clearFix">
	                   				<img  src="images/act_18combination_succ.jpg" alt="" />
								</div>
							</div>
							<!-- 领过了 -->
							<div class="has_received " style="display: none;">
								<div class=" getHbnNum clearFix">
									<img  src="images/act_18combination_fail.jpg" alt="" />
								</div>
							</div>
			...
			<div class="activeRuleShowWrap ">
				<div class="comShowTitle">
					<img src="images/act_18combination_title.jpg" />
				</div>
				<div class="activeRuleShow">
					<p>1.此券包内优惠券仅限在康佰馨昆泰店、石佛营店、丽都店三家店内使用</p>
					<p>2.26元免单券：全场通用，使用时需支付6元运费。</span></p>
					<p>3.满减券：可与药快到平台其它优惠累计使用，豪享折上折！</p>
	...
	<script>
	var wechatObj = new Object();
	wechatObj.title = '【药快到】好久不见，送你一份健康豪礼！';
	wechatObj.desc = '免单券、满减折上折，等你来领！';
	wechatObj.link = location.href.split('#')[0];
	wechatObj.imgUrl = 'http://imgstore.camore.cn/medhtml/common/images/act_18combination_shareImg.jpg';
