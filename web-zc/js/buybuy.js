...
$(function () {
    ...
    $.ajax({
        type: "get",
        url: "http://localhost/zc/php/buy.php",
        dataTypel: "json",
    ...
    function buyView(data) {
        $(data).each(function (index, ele) {
            $(".seckill-goods-list").append("<li class='r8 r'><a href='#' class='r7'><img class='ra' src='" + data[index].buyimg + "'><p class='rb'>" + data[index].buytitle + "</p><div class='qx'><i class='qy'><em class='r6'>￥</em>" + data[index].buyyj + "</i></div></div></a><a class='qz rt'><i class='r6'></i>" + data[index].buyxj + "<i class='r5'>&nbsp;&nbsp;抢</i></a><p class='rs'>" + data[index].buyshop + "</p></li>");
        });
