...
<script>
	...
	var locaAddr = "${method }";
	var redirect_uri = 'http%3a%2f%2f' + location.host + '%2fmedhtml%2fcommon%2factivity%2f'+codeActId+'%3fact_url=' + locaAddr;
//	var redirect_uri = 'http%3a%2f%2f' + 'deve.ykd365.com' + '%2fmedhtml%2fcommon%2factivity%2f'+codeActId+'%3fact_url=' + locaAddr;
												//	   + '%2fmedhtml%2fcommon%2factivity%2f'+codeActId+'%3fact_url=' + act_url;
	if (is_weixin()) {
	...
	//	locaAddr = 'activity?act_url=' +locaAddr + '&codeActId=' + codeActId + '&token=' + token + '&version=' + version;
		locaAddr = 'activity/'+codeActId+'?act_url=' +locaAddr + '&token=' + token + '&version=' + version;
		/*此处是准生产和生产环境  */
